# Authoring task: mng-what-is-optimize-110

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/managing-development/mng-what-is-optimize-110.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mng-what-is-optimize-110` (use exactly this id)
...
1. Write the JSON to **pipeline/generation/outputs/managing-development/mng-what-is-optimize-110.json** and nothing else.
2. The id MUST be `mng-what-is-optimize-110`.
