# Authoring task: mng-delete-finished-instances-54

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/managing-development/mng-delete-finished-instances-54.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mng-delete-finished-instances-54` (use exactly this id)
...
- **Heading focus** (optional steer): "Delete process instance from Processes page"
...
**Section heading**: Delete process instance from Processes page
...
1. Write the JSON to **pipeline/generation/outputs/managing-development/mng-delete-finished-instances-54.json** and nothing else.
2. The id MUST be `mng-delete-finished-instances-54`.
...
Overwrite `pipeline/generation/outputs/managing-development/mng-delete-finished-instances-54.json` with a corrected JSON document and stop.
