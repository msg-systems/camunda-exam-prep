# Authoring task: mng-delete-finished-instances-56

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/managing-development/mng-delete-finished-instances-56.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mng-delete-finished-instances-56` (use exactly this id)
- **topic**: `managing-development`
- **difficulty**: `easy`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/operate/userguide/delete-finished-instances/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Delete process instance from instance detail page"
...
**File**: `pipeline/sources/managing-development/delete-finished-instances.md`
**Public URL**: https://docs.camunda.io/docs/components/operate/userguide/delete-finished-instances/
**Section heading**: Delete process instance from instance detail page
...
1. Write the JSON to **pipeline/generation/outputs/managing-development/mng-delete-finished-instances-56.json** and nothing else.
2. The id MUST be `mng-delete-finished-instances-56`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/operate/userguide/delete-finished-instances/`.
...
Overwrite `pipeline/generation/outputs/managing-development/mng-delete-finished-instances-56.json` with a corrected JSON document and stop.
