# Authoring task: mng-process-instance-modification-29

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/managing-development/mng-process-instance-modification-29.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mng-process-instance-modification-29` (use exactly this id)
- **topic**: `managing-development`
- **difficulty**: `easy`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/operate/userguide/process-instance-modification/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Maximum token modification limit"
...
**File**: `pipeline/sources/managing-development/process-instance-modification.md`
**Public URL**: https://docs.camunda.io/docs/components/operate/userguide/process-instance-modification/
**Section heading**: Maximum token modification limit
...
1. Write the JSON to **pipeline/generation/outputs/managing-development/mng-process-instance-modification-29.json** and nothing else.
2. The id MUST be `mng-process-instance-modification-29`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/operate/userguide/process-instance-modification/`.
...
Overwrite `pipeline/generation/outputs/managing-development/mng-process-instance-modification-29.json` with a corrected JSON document and stop.
