# Authoring task: mng-what-is-optimize-113

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/managing-development/mng-what-is-optimize-113.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mng-what-is-optimize-113` (use exactly this id)
- **topic**: `managing-development`
- **difficulty**: `hard`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/optimize/what-is-optimize/`
...
**File**: `pipeline/sources/managing-development/what-is-optimize.md`
**Public URL**: https://docs.camunda.io/docs/components/optimize/what-is-optimize/
...
1. Write the JSON to **pipeline/generation/outputs/managing-development/mng-what-is-optimize-113.json** and nothing else.
2. The id MUST be `mng-what-is-optimize-113`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/optimize/what-is-optimize/`.
