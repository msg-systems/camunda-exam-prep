...
1. Write the JSON to **pipeline/generation/outputs/managing-development/mng-delete-resources-86.json** and nothing else.
2. The id MUST be `mng-delete-resources-86`.
