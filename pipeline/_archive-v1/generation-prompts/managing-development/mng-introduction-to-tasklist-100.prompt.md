# Authoring task: mng-introduction-to-tasklist-100

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/managing-development/mng-introduction-to-tasklist-100.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mng-introduction-to-tasklist-100` (use exactly this id)
- **topic**: `managing-development`
- **difficulty**: `easy`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/tasklist/introduction-to-tasklist/`
...
**File**: `pipeline/sources/managing-development/introduction-to-tasklist.md`
**Public URL**: https://docs.camunda.io/docs/components/tasklist/introduction-to-tasklist/
...
1. Write the JSON to **pipeline/generation/outputs/managing-development/mng-introduction-to-tasklist-100.json** and nothing else.
2. The id MUST be `mng-introduction-to-tasklist-100`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/tasklist/introduction-to-tasklist/`.
...
Overwrite `pipeline/generation/outputs/managing-development/mng-introduction-to-tasklist-100.json` with a corrected JSON document and stop.
