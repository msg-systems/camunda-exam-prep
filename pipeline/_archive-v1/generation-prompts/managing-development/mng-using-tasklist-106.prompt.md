...
- **Heading focus** (optional steer): "Task details"
...
1. Write the JSON to **pipeline/generation/outputs/managing-development/mng-using-tasklist-106.json** and nothing else.
2. The id MUST be `mng-using-tasklist-106`.
