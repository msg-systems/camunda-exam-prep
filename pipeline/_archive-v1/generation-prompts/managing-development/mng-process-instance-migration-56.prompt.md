# Authoring task: mng-process-instance-migration-56

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/managing-development/mng-process-instance-migration-56.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mng-process-instance-migration-56` (use exactly this id)
- **topic**: `managing-development`
- **difficulty**: `medium`
- **style**: `recall`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/operate/userguide/process-instance-migration/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Process instance selection"
...
**File**: `pipeline/sources/managing-development/process-instance-migration.md`
**Public URL**: https://docs.camunda.io/docs/components/operate/userguide/process-instance-migration/
**Section heading**: Process instance selection
...
1. Write the JSON to **pipeline/generation/outputs/managing-development/mng-process-instance-migration-56.json** and nothing else.
2. The id MUST be `mng-process-instance-migration-56`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/operate/userguide/process-instance-migration/`.
...
Overwrite `pipeline/generation/outputs/managing-development/mng-process-instance-migration-56.json` with a corrected JSON document and stop.
