...
- **Heading focus** (optional steer): "Delete decision definition from Decisions Page"
...
**Section heading**: Delete decision definition from Decisions Page
...
1. Write the JSON to **pipeline/generation/outputs/managing-development/mng-delete-resources-85.json** and nothing else.
2. The id MUST be `mng-delete-resources-85`.
