# Authoring task: mng-monitor-operation-status-96

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/managing-development/mng-monitor-operation-status-96.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mng-monitor-operation-status-96` (use exactly this id)
- **topic**: `managing-development`
- **difficulty**: `easy`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/operate/userguide/monitor-operation-status/`
...
**File**: `pipeline/sources/managing-development/monitor-operation-status.md`
**Public URL**: https://docs.camunda.io/docs/components/operate/userguide/monitor-operation-status/
...
1. Write the JSON to **pipeline/generation/outputs/managing-development/mng-monitor-operation-status-96.json** and nothing else.
2. The id MUST be `mng-monitor-operation-status-96`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/operate/userguide/monitor-operation-status/`.
