# Authoring task: mng-process-instance-modification-49

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/managing-development/mng-process-instance-modification-49.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mng-process-instance-modification-49` (use exactly this id)
...
- **Heading focus** (optional steer): "View summary of pending modifications"
...
**Section heading**: View summary of pending modifications
...
1. Write the JSON to **pipeline/generation/outputs/managing-development/mng-process-instance-modification-49.json** and nothing else.
2. The id MUST be `mng-process-instance-modification-49`.
