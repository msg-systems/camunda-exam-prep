# Authoring task: mng-selections-operations-75

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/managing-development/mng-selections-operations-75.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mng-selections-operations-75` (use exactly this id)
- **topic**: `managing-development`
- **difficulty**: `medium`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/operate/userguide/selections-operations/`
...
**File**: `pipeline/sources/managing-development/selections-operations.md`
**Public URL**: https://docs.camunda.io/docs/components/operate/userguide/selections-operations/
...
1. Write the JSON to **pipeline/generation/outputs/managing-development/mng-selections-operations-75.json** and nothing else.
2. The id MUST be `mng-selections-operations-75`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/operate/userguide/selections-operations/`.
...
Overwrite `pipeline/generation/outputs/managing-development/mng-selections-operations-75.json` with a corrected JSON document and stop.
