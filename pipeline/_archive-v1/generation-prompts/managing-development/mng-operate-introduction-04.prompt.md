# Authoring task: mng-operate-introduction-04

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/managing-development/mng-operate-introduction-04.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mng-operate-introduction-04` (use exactly this id)
- **topic**: `managing-development`
- **difficulty**: `medium`
- **style**: `recall`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/operate/operate-introduction/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Availability"
...
**File**: `pipeline/sources/managing-development/operate-introduction.md`
**Public URL**: https://docs.camunda.io/docs/components/operate/operate-introduction/
...
1. Write the JSON to **pipeline/generation/outputs/managing-development/mng-operate-introduction-04.json** and nothing else.
2. The id MUST be `mng-operate-introduction-04`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/operate/operate-introduction/`.
