...
1. Write the JSON to **pipeline/generation/outputs/managing-development/mng-what-is-optimize-67.json** and nothing else.
2. The id MUST be `mng-what-is-optimize-67`.
