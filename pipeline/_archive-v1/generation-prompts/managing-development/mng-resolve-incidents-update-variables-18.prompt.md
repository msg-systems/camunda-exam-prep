# Authoring task: mng-resolve-incidents-update-variables-18

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/managing-development/mng-resolve-incidents-update-variables-18.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mng-resolve-incidents-update-variables-18` (use exactly this id)
...
1. Write the JSON to **pipeline/generation/outputs/managing-development/mng-resolve-incidents-update-variables-18.json** and nothing else.
2. The id MUST be `mng-resolve-incidents-update-variables-18`.
...
Overwrite `pipeline/generation/outputs/managing-development/mng-resolve-incidents-update-variables-18.json` with a corrected JSON document and stop.
