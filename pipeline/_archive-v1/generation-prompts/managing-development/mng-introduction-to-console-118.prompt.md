# Authoring task: mng-introduction-to-console-118

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/managing-development/mng-introduction-to-console-118.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mng-introduction-to-console-118` (use exactly this id)
- **topic**: `managing-development`
- **difficulty**: `easy`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/console/introduction-to-console/`
...
**File**: `pipeline/sources/managing-development/introduction-to-console.md`
**Public URL**: https://docs.camunda.io/docs/components/console/introduction-to-console/
...
1. Write the JSON to **pipeline/generation/outputs/managing-development/mng-introduction-to-console-118.json** and nothing else.
2. The id MUST be `mng-introduction-to-console-118`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/console/introduction-to-console/`.
