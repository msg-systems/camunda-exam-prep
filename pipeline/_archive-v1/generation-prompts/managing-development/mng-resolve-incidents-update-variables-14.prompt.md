# Authoring task: mng-resolve-incidents-update-variables-14

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/managing-development/mng-resolve-incidents-update-variables-14.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mng-resolve-incidents-update-variables-14` (use exactly this id)
- **topic**: `managing-development`
- **difficulty**: `medium`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/operate/userguide/resolve-incidents-update-variables/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Advance an instance to an XOR gateway"
...
**File**: `pipeline/sources/managing-development/resolve-incidents-update-variables.md`
**Public URL**: https://docs.camunda.io/docs/components/operate/userguide/resolve-incidents-update-variables/
**Section heading**: Advance an instance to an XOR gateway
...
1. Write the JSON to **pipeline/generation/outputs/managing-development/mng-resolve-incidents-update-variables-14.json** and nothing else.
2. The id MUST be `mng-resolve-incidents-update-variables-14`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/operate/userguide/resolve-incidents-update-variables/`.
...
- [option-length-ratio] option length ratio 2.14 > 1.4 @ options

Overwrite `pipeline/generation/outputs/managing-development/mng-resolve-incidents-update-variables-14.json` with a corrected JSON document and stop.
