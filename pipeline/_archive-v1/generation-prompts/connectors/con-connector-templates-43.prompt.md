...
- **Heading focus** (optional steer): "Inbound start event connector templates"
...
**Section heading**: Inbound start event connector templates
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-connector-templates-43.json** and nothing else.
2. The id MUST be `con-connector-templates-43`.
...
Overwrite `pipeline/generation/outputs/connectors/con-connector-templates-43.json` with a corrected JSON document and stop.
