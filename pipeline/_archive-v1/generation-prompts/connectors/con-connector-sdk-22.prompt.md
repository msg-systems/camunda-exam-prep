...
- **Heading focus** (optional steer): "Docker runtime image"
...
**Section heading**: Docker runtime image
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-connector-sdk-22.json** and nothing else.
2. The id MUST be `con-connector-sdk-22`.
