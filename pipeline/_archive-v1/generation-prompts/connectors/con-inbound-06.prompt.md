...
- **Heading focus** (optional steer): "Example: Configuring an HTTP webhook"
...
**Section heading**: Example: Configuring an HTTP webhook
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-inbound-06.json** and nothing else.
2. The id MUST be `con-inbound-06`.
