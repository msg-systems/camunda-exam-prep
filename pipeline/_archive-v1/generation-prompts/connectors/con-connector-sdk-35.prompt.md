...
- **Heading focus** (optional steer): "Inbound connector element template"
...
**Section heading**: Inbound connector element template
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-connector-sdk-35.json** and nothing else.
2. The id MUST be `con-connector-sdk-35`.
