# Authoring task: con-configuring-out-of-the-box-connector-14

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/connectors/con-configuring-out-of-the-box-connector-14.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `con-configuring-out-of-the-box-connector-14` (use exactly this id)
- **topic**: `connectors`
- **difficulty**: `easy`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-configuring-out-of-the-box-connector-14.json** and nothing else.
2. The id MUST be `con-configuring-out-of-the-box-connector-14`.
