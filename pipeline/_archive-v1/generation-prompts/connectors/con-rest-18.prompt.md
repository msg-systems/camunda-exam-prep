...
- **Heading focus** (optional steer): "REST connector (OAuth token)"
...
**Section heading**: REST connector (OAuth token)
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-rest-18.json** and nothing else.
2. The id MUST be `con-rest-18`.
...
Overwrite `pipeline/generation/outputs/connectors/con-rest-18.json` with a corrected JSON document and stop.
