...
- **Heading focus** (optional steer): "Outbound connector runtime logic"
...
**Section heading**: Outbound connector runtime logic
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-connector-sdk-33.json** and nothing else.
2. The id MUST be `con-connector-sdk-33`.
