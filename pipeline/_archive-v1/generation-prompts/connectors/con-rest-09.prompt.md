...
- **Heading focus** (optional steer): "Request"
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-rest-09.json** and nothing else.
2. The id MUST be `con-rest-09`.
