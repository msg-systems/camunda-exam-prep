...
- **Heading focus** (optional steer): "Activate the HTTP Webhook connector by deploying your diagram"
...
**Section heading**: Activate the HTTP Webhook connector by deploying your diagram
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-http-webhook-23.json** and nothing else.
2. The id MUST be `con-http-webhook-23`.
