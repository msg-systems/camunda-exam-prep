...
- **Heading focus** (optional steer): "Configuring the HTTP Polling connector"
...
**Section heading**: Configuring the HTTP Polling connector
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-polling-14.json** and nothing else.
2. The id MUST be `con-polling-14`.
