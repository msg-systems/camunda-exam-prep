...
- **Heading focus** (optional steer): "Function jobError()"
...
**Section heading**: Function jobError()
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-use-connectors-08.json** and nothing else.
2. The id MUST be `con-use-connectors-08`.
...
Overwrite `pipeline/generation/outputs/connectors/con-use-connectors-08.json` with a corrected JSON document and stop.
