...
- **Heading focus** (optional steer): "Runtime environments"
...
**Section heading**: Runtime environments
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-connector-sdk-39.json** and nothing else.
2. The id MUST be `con-connector-sdk-39`.
...
Overwrite `pipeline/generation/outputs/connectors/con-connector-sdk-39.json` with a corrected JSON document and stop.
