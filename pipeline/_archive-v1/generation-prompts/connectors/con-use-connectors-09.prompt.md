...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-use-connectors-09.json** and nothing else.
2. The id MUST be `con-use-connectors-09`.
...
Overwrite `pipeline/generation/outputs/connectors/con-use-connectors-09.json` with a corrected JSON document and stop.
