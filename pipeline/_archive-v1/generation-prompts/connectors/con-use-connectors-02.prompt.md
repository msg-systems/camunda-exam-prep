...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-use-connectors-02.json** and nothing else.
2. The id MUST be `con-use-connectors-02`.
