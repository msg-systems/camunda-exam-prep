...
- **Heading focus** (optional steer): "Response expression"
...
**Section heading**: Response expression
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-http-webhook-13.json** and nothing else.
2. The id MUST be `con-http-webhook-13`.
