...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-connector-templates-26.json** and nothing else.
2. The id MUST be `con-connector-templates-26`.
