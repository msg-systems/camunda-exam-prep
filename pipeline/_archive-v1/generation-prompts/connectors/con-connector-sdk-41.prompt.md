...
- **Heading focus** (optional steer): "Custom runtime environment"
...
**Section heading**: Custom runtime environment
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-connector-sdk-41.json** and nothing else.
2. The id MUST be `con-connector-sdk-41`.
...
Overwrite `pipeline/generation/outputs/connectors/con-connector-sdk-41.json` with a corrected JSON document and stop.
