...
- **Heading focus** (optional steer): "Outbound connector project outline"
...
**Section heading**: Outbound connector project outline
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-connector-sdk-31.json** and nothing else.
2. The id MUST be `con-connector-sdk-31`.
