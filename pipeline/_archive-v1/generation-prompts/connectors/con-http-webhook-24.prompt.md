...
- **Heading focus** (optional steer): "How to configure API key authorization"
...
**Section heading**: How to configure API key authorization
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-http-webhook-24.json** and nothing else.
2. The id MUST be `con-http-webhook-24`.
...
Overwrite `pipeline/generation/outputs/connectors/con-http-webhook-24.json` with a corrected JSON document and stop.
