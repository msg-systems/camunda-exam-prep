...
- **Heading focus** (optional steer): "Verification expression"
...
**Section heading**: Verification expression
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-http-webhook-12.json** and nothing else.
2. The id MUST be `con-http-webhook-12`.
