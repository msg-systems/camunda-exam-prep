...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-rest-17.json** and nothing else.
2. The id MUST be `con-rest-17`.
...
Overwrite `pipeline/generation/outputs/connectors/con-rest-17.json` with a corrected JSON document and stop.
