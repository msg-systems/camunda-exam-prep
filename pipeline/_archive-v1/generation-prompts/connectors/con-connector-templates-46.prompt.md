...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-connector-templates-46.json** and nothing else.
2. The id MUST be `con-connector-templates-46`.
...
Overwrite `pipeline/generation/outputs/connectors/con-connector-templates-46.json` with a corrected JSON document and stop.
