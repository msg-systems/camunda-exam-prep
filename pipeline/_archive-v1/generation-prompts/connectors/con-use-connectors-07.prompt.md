...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-use-connectors-07.json** and nothing else.
2. The id MUST be `con-use-connectors-07`.
...
Overwrite `pipeline/generation/outputs/connectors/con-use-connectors-07.json` with a corrected JSON document and stop.
