...
- **Heading focus** (optional steer): "Working with request context"
...
**Section heading**: Working with request context
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-inbound-12.json** and nothing else.
2. The id MUST be `con-inbound-12`.
...
Overwrite `pipeline/generation/outputs/connectors/con-inbound-12.json` with a corrected JSON document and stop.
