...
- **Heading focus** (optional steer): "How to extract roles from JWT data"
...
**Section heading**: How to extract roles from JWT data
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-http-webhook-25.json** and nothing else.
2. The id MUST be `con-http-webhook-25`.
