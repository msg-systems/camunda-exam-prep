# Authoring task: con-polling-29

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/connectors/con-polling-29.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `con-polling-29` (use exactly this id)
- **topic**: `connectors`
- **difficulty**: `easy`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/connectors/protocol/polling/`
...
**File**: `pipeline/sources/connectors/polling.md`
**Public URL**: https://docs.camunda.io/docs/components/connectors/protocol/polling/
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-polling-29.json** and nothing else.
2. The id MUST be `con-polling-29`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/connectors/protocol/polling/`.
...
Overwrite `pipeline/generation/outputs/connectors/con-polling-29.json` with a corrected JSON document and stop.
