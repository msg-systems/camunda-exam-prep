# Authoring task: con-outbound-13

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/connectors/con-outbound-13.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `con-outbound-13` (use exactly this id)
- **topic**: `connectors`
- **difficulty**: `medium`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/connectors/use-connectors/outbound/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Retries"
...
**File**: `pipeline/sources/connectors/outbound.md`
**Public URL**: https://docs.camunda.io/docs/components/connectors/use-connectors/outbound/
**Section heading**: Retries
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-outbound-13.json** and nothing else.
2. The id MUST be `con-outbound-13`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/connectors/use-connectors/outbound/`.
