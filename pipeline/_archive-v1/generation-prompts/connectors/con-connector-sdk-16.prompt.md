...
- **Heading focus** (optional steer): "Outbound connector element template"
...
**Section heading**: Outbound connector element template
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-connector-sdk-16.json** and nothing else.
2. The id MUST be `con-connector-sdk-16`.
