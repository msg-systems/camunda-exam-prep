...
- **Heading focus** (optional steer): "Inbound connector project outline"
...
**Section heading**: Inbound connector project outline
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-connector-sdk-18.json** and nothing else.
2. The id MUST be `con-connector-sdk-18`.
...
Overwrite `pipeline/generation/outputs/connectors/con-connector-sdk-18.json` with a corrected JSON document and stop.
