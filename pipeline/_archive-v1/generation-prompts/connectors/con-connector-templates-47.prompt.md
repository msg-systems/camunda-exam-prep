...
- **Heading focus** (optional steer): "Outbound connector templates"
...
**Section heading**: Outbound connector templates
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-connector-templates-47.json** and nothing else.
2. The id MUST be `con-connector-templates-47`.
...
Overwrite `pipeline/generation/outputs/connectors/con-connector-templates-47.json` with a corrected JSON document and stop.
