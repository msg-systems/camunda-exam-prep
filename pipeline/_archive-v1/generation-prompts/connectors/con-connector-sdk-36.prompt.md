...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-connector-sdk-36.json** and nothing else.
2. The id MUST be `con-connector-sdk-36`.
