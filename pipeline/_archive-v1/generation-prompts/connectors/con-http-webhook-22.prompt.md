...
- **Heading focus** (optional steer): "Correlation"
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-http-webhook-22.json** and nothing else.
2. The id MUST be `con-http-webhook-22`.
...
Overwrite `pipeline/generation/outputs/connectors/con-http-webhook-22.json` with a corrected JSON document and stop.
