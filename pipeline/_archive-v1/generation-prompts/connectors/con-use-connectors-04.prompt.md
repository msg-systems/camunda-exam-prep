...
- **Heading focus** (optional steer): "BPMN error examples"
...
**Section heading**: BPMN error examples
...
1. Write the JSON to **pipeline/generation/outputs/connectors/con-use-connectors-04.json** and nothing else.
2. The id MUST be `con-use-connectors-04`.
...
Overwrite `pipeline/generation/outputs/connectors/con-use-connectors-04.json` with a corrected JSON document and stop.
