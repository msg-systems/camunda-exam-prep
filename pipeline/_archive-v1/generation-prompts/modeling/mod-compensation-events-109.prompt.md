...
- **Heading focus** (optional steer): "Triggering compensation for a specific activity"
...
**Section heading**: Triggering compensation for a specific activity
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-compensation-events-109.json** and nothing else.
2. The id MUST be `mod-compensation-events-109`.
