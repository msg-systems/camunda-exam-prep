...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-event-based-gateways-78.json** and nothing else.
2. The id MUST be `mod-event-based-gateways-78`.
