...
- **Heading focus** (optional steer): "Special ad-hoc sub-process variables"
...
**Section heading**: Special ad-hoc sub-process variables
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-ad-hoc-subprocesses-40.json** and nothing else.
2. The id MUST be `mod-ad-hoc-subprocesses-40`.
