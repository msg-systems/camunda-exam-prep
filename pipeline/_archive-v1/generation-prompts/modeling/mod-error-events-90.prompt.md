...
- **Heading focus** (optional steer): "Throwing the error"
...
**Section heading**: Throwing the error
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-error-events-90.json** and nothing else.
2. The id MUST be `mod-error-events-90`.
