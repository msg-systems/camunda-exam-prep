...
- **Heading focus** (optional steer): "Message throw events"
...
**Section heading**: Message throw events
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-message-events-53.json** and nothing else.
2. The id MUST be `mod-message-events-53`.
