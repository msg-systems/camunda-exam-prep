...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-terminate-events-103.json** and nothing else.
2. The id MUST be `mod-terminate-events-103`.
