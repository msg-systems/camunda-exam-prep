# Authoring task: mod-send-tasks-42

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/modeling/mod-send-tasks-42.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mod-send-tasks-42` (use exactly this id)
- **topic**: `modeling`
- **difficulty**: `medium`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/bpmn/send-tasks/`
...
**File**: `pipeline/sources/modeling/send-tasks.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/bpmn/send-tasks/
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-send-tasks-42.json** and nothing else.
2. The id MUST be `mod-send-tasks-42`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/bpmn/send-tasks/`.
...
Overwrite `pipeline/generation/outputs/modeling/mod-send-tasks-42.json` with a corrected JSON document and stop.
