...
- **Heading focus** (optional steer): "Markers"
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-bpmn-coverage-04.json** and nothing else.
2. The id MUST be `mod-bpmn-coverage-04`.
...
Overwrite `pipeline/generation/outputs/modeling/mod-bpmn-coverage-04.json` with a corrected JSON document and stop.
