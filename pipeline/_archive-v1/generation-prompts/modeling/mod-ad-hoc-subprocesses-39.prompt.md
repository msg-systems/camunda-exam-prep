# Authoring task: mod-ad-hoc-subprocesses-39

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/modeling/mod-ad-hoc-subprocesses-39.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mod-ad-hoc-subprocesses-39` (use exactly this id)
- **topic**: `modeling`
- **difficulty**: `hard`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/bpmn/ad-hoc-subprocesses/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Collect output"
...
**File**: `pipeline/sources/modeling/ad-hoc-subprocesses.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/bpmn/ad-hoc-subprocesses/
**Section heading**: Collect output
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-ad-hoc-subprocesses-39.json** and nothing else.
2. The id MUST be `mod-ad-hoc-subprocesses-39`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/bpmn/ad-hoc-subprocesses/`.
...
Overwrite `pipeline/generation/outputs/modeling/mod-ad-hoc-subprocesses-39.json` with a corrected JSON document and stop.
