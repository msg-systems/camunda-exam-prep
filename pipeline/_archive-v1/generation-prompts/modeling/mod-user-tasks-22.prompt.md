...
- **Heading focus** (optional steer): "Scheduling"
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-user-tasks-22.json** and nothing else.
2. The id MUST be `mod-user-tasks-22`.
...
Overwrite `pipeline/generation/outputs/modeling/mod-user-tasks-22.json` with a corrected JSON document and stop.
