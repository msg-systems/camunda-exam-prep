...
- **Heading focus** (optional steer): "Subprocesses"
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-bpmn-coverage-07.json** and nothing else.
2. The id MUST be `mod-bpmn-coverage-07`.
