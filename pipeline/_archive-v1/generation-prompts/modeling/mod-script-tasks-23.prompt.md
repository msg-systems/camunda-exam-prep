...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-script-tasks-23.json** and nothing else.
2. The id MUST be `mod-script-tasks-23`.
...
Overwrite `pipeline/generation/outputs/modeling/mod-script-tasks-23.json` with a corrected JSON document and stop.
