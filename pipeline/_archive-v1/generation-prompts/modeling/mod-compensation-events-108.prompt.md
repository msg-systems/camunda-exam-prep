...
- **Heading focus** (optional steer): "Compensating multi-instance activities"
...
**Section heading**: Compensating multi-instance activities
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-compensation-events-108.json** and nothing else.
2. The id MUST be `mod-compensation-events-108`.
