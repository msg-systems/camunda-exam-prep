# Authoring task: mod-business-rule-tasks-32

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/modeling/mod-business-rule-tasks-32.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mod-business-rule-tasks-32` (use exactly this id)
- **topic**: `modeling`
- **difficulty**: `medium`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/bpmn/business-rule-tasks/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Defining a called decision {#defining-a-task}"
...
**File**: `pipeline/sources/modeling/business-rule-tasks.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/bpmn/business-rule-tasks/
**Section heading**: Defining a called decision {#defining-a-task}
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-business-rule-tasks-32.json** and nothing else.
2. The id MUST be `mod-business-rule-tasks-32`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/bpmn/business-rule-tasks/`.
