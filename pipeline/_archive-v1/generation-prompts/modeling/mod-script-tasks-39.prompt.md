...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-script-tasks-39.json** and nothing else.
2. The id MUST be `mod-script-tasks-39`.
...
Overwrite `pipeline/generation/outputs/modeling/mod-script-tasks-39.json` with a corrected JSON document and stop.
