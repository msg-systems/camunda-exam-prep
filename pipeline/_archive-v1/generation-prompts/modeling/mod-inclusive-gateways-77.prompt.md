# Authoring task: mod-inclusive-gateways-77

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/modeling/mod-inclusive-gateways-77.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mod-inclusive-gateways-77` (use exactly this id)
- **topic**: `modeling`
- **difficulty**: `medium`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/bpmn/inclusive-gateways/`
...
**File**: `pipeline/sources/modeling/inclusive-gateways.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/bpmn/inclusive-gateways/
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-inclusive-gateways-77.json** and nothing else.
2. The id MUST be `mod-inclusive-gateways-77`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/bpmn/inclusive-gateways/`.
