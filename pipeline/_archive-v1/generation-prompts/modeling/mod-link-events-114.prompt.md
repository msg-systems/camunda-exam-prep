# Authoring task: mod-link-events-114

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/modeling/mod-link-events-114.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mod-link-events-114` (use exactly this id)
- **topic**: `modeling`
- **difficulty**: `medium`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/bpmn/link-events/`
...
**File**: `pipeline/sources/modeling/link-events.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/bpmn/link-events/
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-link-events-114.json** and nothing else.
2. The id MUST be `mod-link-events-114`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/bpmn/link-events/`.
