# Authoring task: mod-event-based-gateways-50

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/modeling/mod-event-based-gateways-50.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mod-event-based-gateways-50` (use exactly this id)
- **topic**: `modeling`
- **difficulty**: `hard`
- **style**: `recall`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/bpmn/event-based-gateways/`
...
**File**: `pipeline/sources/modeling/event-based-gateways.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/bpmn/event-based-gateways/
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-event-based-gateways-50.json** and nothing else.
2. The id MUST be `mod-event-based-gateways-50`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/bpmn/event-based-gateways/`.
