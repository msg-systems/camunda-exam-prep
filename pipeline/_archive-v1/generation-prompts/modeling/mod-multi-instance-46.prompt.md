# Authoring task: mod-multi-instance-46

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/modeling/mod-multi-instance-46.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mod-multi-instance-46` (use exactly this id)
- **topic**: `modeling`
- **difficulty**: `easy`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/bpmn/multi-instance/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Additional resources"
...
**File**: `pipeline/sources/modeling/multi-instance.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/bpmn/multi-instance/
**Section heading**: Additional resources
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-multi-instance-46.json** and nothing else.
2. The id MUST be `mod-multi-instance-46`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/bpmn/multi-instance/`.
...
Overwrite `pipeline/generation/outputs/modeling/mod-multi-instance-46.json` with a corrected JSON document and stop.
