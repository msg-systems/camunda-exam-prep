...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-inclusive-gateways-48.json** and nothing else.
2. The id MUST be `mod-inclusive-gateways-48`.
