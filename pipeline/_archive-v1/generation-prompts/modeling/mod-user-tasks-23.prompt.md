...
- **Heading focus** (optional steer): "Define user task priority"
...
**Section heading**: Define user task priority
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-user-tasks-23.json** and nothing else.
2. The id MUST be `mod-user-tasks-23`.
...
Overwrite `pipeline/generation/outputs/modeling/mod-user-tasks-23.json` with a corrected JSON document and stop.
