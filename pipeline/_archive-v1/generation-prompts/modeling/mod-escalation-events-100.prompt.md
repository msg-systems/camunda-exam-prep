...
- **Heading focus** (optional steer): "Defining an escalation"
...
**Section heading**: Defining an escalation
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-escalation-events-100.json** and nothing else.
2. The id MUST be `mod-escalation-events-100`.
