# Authoring task: mod-parallel-gateways-74

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/modeling/mod-parallel-gateways-74.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mod-parallel-gateways-74` (use exactly this id)
- **topic**: `modeling`
- **difficulty**: `hard`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/bpmn/parallel-gateways/`
...
**File**: `pipeline/sources/modeling/parallel-gateways.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/bpmn/parallel-gateways/
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-parallel-gateways-74.json** and nothing else.
2. The id MUST be `mod-parallel-gateways-74`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/bpmn/parallel-gateways/`.
