...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-signal-events-64.json** and nothing else.
2. The id MUST be `mod-signal-events-64`.
...
Overwrite `pipeline/generation/outputs/modeling/mod-signal-events-64.json` with a corrected JSON document and stop.
