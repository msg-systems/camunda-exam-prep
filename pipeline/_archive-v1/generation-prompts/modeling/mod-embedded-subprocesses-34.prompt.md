# Authoring task: mod-embedded-subprocesses-34

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/modeling/mod-embedded-subprocesses-34.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mod-embedded-subprocesses-34` (use exactly this id)
- **topic**: `modeling`
- **difficulty**: `medium`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/bpmn/embedded-subprocesses/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Collapsed subprocesses"
...
**File**: `pipeline/sources/modeling/embedded-subprocesses.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/bpmn/embedded-subprocesses/
**Section heading**: Collapsed subprocesses
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-embedded-subprocesses-34.json** and nothing else.
2. The id MUST be `mod-embedded-subprocesses-34`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/bpmn/embedded-subprocesses/`.
