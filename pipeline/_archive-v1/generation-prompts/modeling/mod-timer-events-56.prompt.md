...
- **Heading focus** (optional steer): "Timer boundary events"
...
**Section heading**: Timer boundary events
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-timer-events-56.json** and nothing else.
2. The id MUST be `mod-timer-events-56`.
