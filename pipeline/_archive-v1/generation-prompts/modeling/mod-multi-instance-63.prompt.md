...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-multi-instance-63.json** and nothing else.
2. The id MUST be `mod-multi-instance-63`.
