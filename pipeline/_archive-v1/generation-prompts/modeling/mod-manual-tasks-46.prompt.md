# Authoring task: mod-manual-tasks-46

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/modeling/mod-manual-tasks-46.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mod-manual-tasks-46` (use exactly this id)
- **topic**: `modeling`
- **difficulty**: `medium`
- **style**: `recall`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/bpmn/manual-tasks/`
...
**File**: `pipeline/sources/modeling/manual-tasks.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/bpmn/manual-tasks/
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-manual-tasks-46.json** and nothing else.
2. The id MUST be `mod-manual-tasks-46`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/bpmn/manual-tasks/`.
