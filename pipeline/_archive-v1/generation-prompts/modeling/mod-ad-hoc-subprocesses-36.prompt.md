...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-ad-hoc-subprocesses-36.json** and nothing else.
2. The id MUST be `mod-ad-hoc-subprocesses-36`.
...
Overwrite `pipeline/generation/outputs/modeling/mod-ad-hoc-subprocesses-36.json` with a corrected JSON document and stop.
