# Authoring task: mod-service-tasks-20

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/modeling/mod-service-tasks-20.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mod-service-tasks-20` (use exactly this id)
- **topic**: `modeling`
- **difficulty**: `medium`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/bpmn/service-tasks/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Task definition"
...
**File**: `pipeline/sources/modeling/service-tasks.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/bpmn/service-tasks/
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-service-tasks-20.json** and nothing else.
2. The id MUST be `mod-service-tasks-20`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/bpmn/service-tasks/`.
...
Overwrite `pipeline/generation/outputs/modeling/mod-service-tasks-20.json` with a corrected JSON document and stop.
