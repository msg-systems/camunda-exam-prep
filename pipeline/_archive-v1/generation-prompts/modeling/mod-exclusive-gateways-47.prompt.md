...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-exclusive-gateways-47.json** and nothing else.
2. The id MUST be `mod-exclusive-gateways-47`.
