...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-escalation-events-99.json** and nothing else.
2. The id MUST be `mod-escalation-events-99`.
