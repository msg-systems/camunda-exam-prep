# Authoring task: mod-event-subprocesses-56

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/modeling/mod-event-subprocesses-56.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mod-event-subprocesses-56` (use exactly this id)
- **topic**: `modeling`
- **difficulty**: `easy`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/bpmn/event-subprocesses/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Variables"
...
**File**: `pipeline/sources/modeling/event-subprocesses.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/bpmn/event-subprocesses/
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-event-subprocesses-56.json** and nothing else.
2. The id MUST be `mod-event-subprocesses-56`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/bpmn/event-subprocesses/`.
