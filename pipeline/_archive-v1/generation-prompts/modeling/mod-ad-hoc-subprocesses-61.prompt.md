...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-ad-hoc-subprocesses-61.json** and nothing else.
2. The id MUST be `mod-ad-hoc-subprocesses-61`.
