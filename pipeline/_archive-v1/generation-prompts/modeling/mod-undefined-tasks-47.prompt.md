# Authoring task: mod-undefined-tasks-47

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/modeling/mod-undefined-tasks-47.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mod-undefined-tasks-47` (use exactly this id)
- **topic**: `modeling`
- **difficulty**: `medium`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/bpmn/undefined-tasks/`
...
**File**: `pipeline/sources/modeling/undefined-tasks.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/bpmn/undefined-tasks/
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-undefined-tasks-47.json** and nothing else.
2. The id MUST be `mod-undefined-tasks-47`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/bpmn/undefined-tasks/`.
...
Overwrite `pipeline/generation/outputs/modeling/mod-undefined-tasks-47.json` with a corrected JSON document and stop.
