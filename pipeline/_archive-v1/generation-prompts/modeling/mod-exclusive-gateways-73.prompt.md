# Authoring task: mod-exclusive-gateways-73

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/modeling/mod-exclusive-gateways-73.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mod-exclusive-gateways-73` (use exactly this id)
- **topic**: `modeling`
- **difficulty**: `easy`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/bpmn/exclusive-gateways/`
...
**File**: `pipeline/sources/modeling/exclusive-gateways.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/bpmn/exclusive-gateways/
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-exclusive-gateways-73.json** and nothing else.
2. The id MUST be `mod-exclusive-gateways-73`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/bpmn/exclusive-gateways/`.
