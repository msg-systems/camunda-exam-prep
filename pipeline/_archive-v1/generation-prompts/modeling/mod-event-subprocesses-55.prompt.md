...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-event-subprocesses-55.json** and nothing else.
2. The id MUST be `mod-event-subprocesses-55`.
