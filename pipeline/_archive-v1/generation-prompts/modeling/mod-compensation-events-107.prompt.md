...
- **Heading focus** (optional steer): "Compensating embedded subprocesses"
...
**Section heading**: Compensating embedded subprocesses
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-compensation-events-107.json** and nothing else.
2. The id MUST be `mod-compensation-events-107`.
