...
- **Heading focus** (optional steer): "Collecting the output"
...
**Section heading**: Collecting the output
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-multi-instance-43.json** and nothing else.
2. The id MUST be `mod-multi-instance-43`.
