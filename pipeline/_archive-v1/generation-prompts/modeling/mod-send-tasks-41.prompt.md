...
- **Heading focus** (optional steer): "Defining a task"
...
**Section heading**: Defining a task
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-send-tasks-41.json** and nothing else.
2. The id MUST be `mod-send-tasks-41`.
