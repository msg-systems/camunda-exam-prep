...
- **Heading focus** (optional steer): "User task listeners"
...
**Section heading**: User task listeners
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-user-tasks-26.json** and nothing else.
2. The id MUST be `mod-user-tasks-26`.
...
Overwrite `pipeline/generation/outputs/modeling/mod-user-tasks-26.json` with a corrected JSON document and stop.
