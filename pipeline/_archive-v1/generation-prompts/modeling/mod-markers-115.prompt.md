# Authoring task: mod-markers-115

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/modeling/mod-markers-115.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mod-markers-115` (use exactly this id)
- **topic**: `modeling`
- **difficulty**: `medium`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/bpmn/markers/`
...
**File**: `pipeline/sources/modeling/markers.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/bpmn/markers/
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-markers-115.json** and nothing else.
2. The id MUST be `mod-markers-115`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/bpmn/markers/`.
