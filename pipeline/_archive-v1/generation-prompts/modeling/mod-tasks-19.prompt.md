# Authoring task: mod-tasks-19

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/modeling/mod-tasks-19.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mod-tasks-19` (use exactly this id)
- **topic**: `modeling`
- **difficulty**: `easy`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/bpmn/tasks/`
...
**File**: `pipeline/sources/modeling/tasks.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/bpmn/tasks/
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-tasks-19.json** and nothing else.
2. The id MUST be `mod-tasks-19`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/bpmn/tasks/`.
