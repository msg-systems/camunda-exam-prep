...
- **Heading focus** (optional steer): "Defining the error"
...
**Section heading**: Defining the error
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-error-events-59.json** and nothing else.
2. The id MUST be `mod-error-events-59`.
