...
- **Heading focus** (optional steer): "Defining the collection to iterate over"
...
**Section heading**: Defining the collection to iterate over
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-multi-instance-65.json** and nothing else.
2. The id MUST be `mod-multi-instance-65`.
