...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-event-based-gateways-79.json** and nothing else.
2. The id MUST be `mod-event-based-gateways-79`.
