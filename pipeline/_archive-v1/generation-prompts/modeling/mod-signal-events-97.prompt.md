...
- **Heading focus** (optional steer): "Signals"
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-signal-events-97.json** and nothing else.
2. The id MUST be `mod-signal-events-97`.
...
Overwrite `pipeline/generation/outputs/modeling/mod-signal-events-97.json` with a corrected JSON document and stop.
