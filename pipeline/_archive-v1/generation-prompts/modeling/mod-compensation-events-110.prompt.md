# Authoring task: mod-compensation-events-110

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/modeling/mod-compensation-events-110.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mod-compensation-events-110` (use exactly this id)
- **topic**: `modeling`
- **difficulty**: `hard`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/bpmn/compensation-events/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Triggering compensation from an event subprocess"
...
**File**: `pipeline/sources/modeling/compensation-events.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/bpmn/compensation-events/
**Section heading**: Triggering compensation from an event subprocess
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-compensation-events-110.json** and nothing else.
2. The id MUST be `mod-compensation-events-110`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/bpmn/compensation-events/`.
