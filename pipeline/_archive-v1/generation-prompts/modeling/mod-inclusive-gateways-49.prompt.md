...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-inclusive-gateways-49.json** and nothing else.
2. The id MUST be `mod-inclusive-gateways-49`.
