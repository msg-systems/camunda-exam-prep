# Authoring task: mod-message-events-52

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/modeling/mod-message-events-52.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `mod-message-events-52` (use exactly this id)
- **topic**: `modeling`
- **difficulty**: `hard`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/bpmn/message-events/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Message start events"
...
**File**: `pipeline/sources/modeling/message-events.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/bpmn/message-events/
**Section heading**: Message start events
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-message-events-52.json** and nothing else.
2. The id MUST be `mod-message-events-52`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/bpmn/message-events/`.
