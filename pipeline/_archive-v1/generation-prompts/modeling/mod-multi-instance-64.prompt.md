...
- **Heading focus** (optional steer): "Sequential vs. parallel"
...
**Section heading**: Sequential vs. parallel
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-multi-instance-64.json** and nothing else.
2. The id MUST be `mod-multi-instance-64`.
