...
- **Heading focus** (optional steer): "Gateways"
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-bpmn-coverage-03.json** and nothing else.
2. The id MUST be `mod-bpmn-coverage-03`.
