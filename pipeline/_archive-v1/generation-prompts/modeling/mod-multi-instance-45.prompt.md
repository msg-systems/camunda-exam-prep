...
- **Heading focus** (optional steer): "Completion condition"
...
**Section heading**: Completion condition
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-multi-instance-45.json** and nothing else.
2. The id MUST be `mod-multi-instance-45`.
...
Overwrite `pipeline/generation/outputs/modeling/mod-multi-instance-45.json` with a corrected JSON document and stop.
