...
- **Heading focus** (optional steer): "Catching the error"
...
**Section heading**: Catching the error
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-error-events-60.json** and nothing else.
2. The id MUST be `mod-error-events-60`.
