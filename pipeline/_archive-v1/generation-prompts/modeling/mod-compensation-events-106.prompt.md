...
- **Heading focus** (optional steer): "Triggering compensation"
...
**Section heading**: Triggering compensation
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-compensation-events-106.json** and nothing else.
2. The id MUST be `mod-compensation-events-106`.
