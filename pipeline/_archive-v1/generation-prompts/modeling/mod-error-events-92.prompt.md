...
- **Heading focus** (optional steer): "Unhandled errors"
...
**Section heading**: Unhandled errors
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-error-events-92.json** and nothing else.
2. The id MUST be `mod-error-events-92`.
