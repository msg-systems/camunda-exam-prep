...
- **Heading focus** (optional steer): "Job worker implementation"
...
**Section heading**: Job worker implementation
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-business-rule-tasks-34.json** and nothing else.
2. The id MUST be `mod-business-rule-tasks-34`.
