...
- **Heading focus** (optional steer): "Tasks"
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-bpmn-coverage-02.json** and nothing else.
2. The id MUST be `mod-bpmn-coverage-02`.
