...
- **Heading focus** (optional steer): "Signal start events"
...
**Section heading**: Signal start events
...
1. Write the JSON to **pipeline/generation/outputs/modeling/mod-signal-events-96.json** and nothing else.
2. The id MUST be `mod-signal-events-96`.
