# Authoring task: dec-decision-table-input-26

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/decisions-business-rules/dec-decision-table-input-26.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `dec-decision-table-input-26` (use exactly this id)
...
- **Heading focus** (optional steer): "Input type definition"
...
**Section heading**: Input type definition
...
1. Write the JSON to **pipeline/generation/outputs/decisions-business-rules/dec-decision-table-input-26.json** and nothing else.
2. The id MUST be `dec-decision-table-input-26`.
...
Overwrite `pipeline/generation/outputs/decisions-business-rules/dec-decision-table-input-26.json` with a corrected JSON document and stop.
