...
**File**: `pipeline/sources/decisions-business-rules/dmn.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/dmn/dmn/
**Section heading**: Business knowledge models
...
1. Write the JSON to **pipeline/generation/outputs/decisions-business-rules/dec-dmn-17.json** and nothing else.
2. The id MUST be `dec-dmn-17`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/dmn/dmn/`.
...
Overwrite `pipeline/generation/outputs/decisions-business-rules/dec-dmn-17.json` with a corrected JSON document and stop.
