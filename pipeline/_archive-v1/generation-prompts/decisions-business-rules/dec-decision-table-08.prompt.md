...
1. Write the JSON to **pipeline/generation/outputs/decisions-business-rules/dec-decision-table-08.json** and nothing else.
2. The id MUST be `dec-decision-table-08`.
