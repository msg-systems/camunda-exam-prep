...
- **Heading focus** (optional steer): "Start modeling"
...
**Section heading**: Start modeling
...
1. Write the JSON to **pipeline/generation/outputs/decisions-business-rules/dec-dmn-10.json** and nothing else.
2. The id MUST be `dec-dmn-10`.
...
Overwrite `pipeline/generation/outputs/decisions-business-rules/dec-dmn-10.json` with a corrected JSON document and stop.
