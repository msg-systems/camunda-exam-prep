# Authoring task: dec-decision-table-09

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/decisions-business-rules/dec-decision-table-09.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `dec-decision-table-09` (use exactly this id)
- **topic**: `decisions-business-rules`
- **difficulty**: `medium`
- **style**: `recall`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/dmn/decision-table/`
...
**File**: `pipeline/sources/decisions-business-rules/decision-table.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/dmn/decision-table/
...
1. Write the JSON to **pipeline/generation/outputs/decisions-business-rules/dec-decision-table-09.json** and nothing else.
2. The id MUST be `dec-decision-table-09`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/dmn/decision-table/`.
...
Overwrite `pipeline/generation/outputs/decisions-business-rules/dec-decision-table-09.json` with a corrected JSON document and stop.
