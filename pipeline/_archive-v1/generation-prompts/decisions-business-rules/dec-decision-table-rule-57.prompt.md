# Authoring task: dec-decision-table-rule-57

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/decisions-business-rules/dec-decision-table-rule-57.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `dec-decision-table-rule-57` (use exactly this id)
- **topic**: `decisions-business-rules`
- **difficulty**: `medium`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/dmn/decision-table-rule/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Output entry"
...
**File**: `pipeline/sources/decisions-business-rules/decision-table-rule.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/dmn/decision-table-rule/
**Section heading**: Output entry
...
1. Write the JSON to **pipeline/generation/outputs/decisions-business-rules/dec-decision-table-rule-57.json** and nothing else.
2. The id MUST be `dec-decision-table-rule-57`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/dmn/decision-table-rule/`.
