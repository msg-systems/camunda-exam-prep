...
- **Heading focus** (optional steer): "Decision tables"
...
**Section heading**: Decision tables
...
1. Write the JSON to **pipeline/generation/outputs/decisions-business-rules/dec-dmn-13.json** and nothing else.
2. The id MUST be `dec-dmn-13`.
...
Overwrite `pipeline/generation/outputs/decisions-business-rules/dec-dmn-13.json` with a corrected JSON document and stop.
