# Authoring task: dec-decision-literal-expression-75

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/decisions-business-rules/dec-decision-literal-expression-75.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `dec-decision-literal-expression-75` (use exactly this id)
- **topic**: `decisions-business-rules`
- **difficulty**: `easy`
- **style**: `recall`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/dmn/decision-literal-expression/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Literal expression"
...
**File**: `pipeline/sources/decisions-business-rules/decision-literal-expression.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/dmn/decision-literal-expression/
**Section heading**: Literal expression
...
1. Write the JSON to **pipeline/generation/outputs/decisions-business-rules/dec-decision-literal-expression-75.json** and nothing else.
2. The id MUST be `dec-decision-literal-expression-75`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/dmn/decision-literal-expression/`.
...
Overwrite `pipeline/generation/outputs/decisions-business-rules/dec-decision-literal-expression-75.json` with a corrected JSON document and stop.
