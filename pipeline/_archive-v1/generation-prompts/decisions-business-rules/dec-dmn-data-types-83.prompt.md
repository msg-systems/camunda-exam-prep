# Authoring task: dec-dmn-data-types-83

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/decisions-business-rules/dec-dmn-data-types-83.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `dec-dmn-data-types-83` (use exactly this id)
- **topic**: `decisions-business-rules`
- **difficulty**: `hard`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/dmn/dmn-data-types/`
...
**File**: `pipeline/sources/decisions-business-rules/dmn-data-types.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/dmn/dmn-data-types/
...
1. Write the JSON to **pipeline/generation/outputs/decisions-business-rules/dec-dmn-data-types-83.json** and nothing else.
2. The id MUST be `dec-dmn-data-types-83`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/dmn/dmn-data-types/`.
...
Overwrite `pipeline/generation/outputs/decisions-business-rules/dec-dmn-data-types-83.json` with a corrected JSON document and stop.
