...
1. Write the JSON to **pipeline/generation/outputs/decisions-business-rules/dec-dmn-data-types-52.json** and nothing else.
2. The id MUST be `dec-dmn-data-types-52`.
