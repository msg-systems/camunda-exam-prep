...
- **Heading focus** (optional steer): "Access components"
...
**Section heading**: Access components
...
1. Write the JSON to **pipeline/generation/outputs/dev-environment/dev-docker-compose-03.json** and nothing else.
2. The id MUST be `dev-docker-compose-03`.
