# Authoring task: dev-getting-started-orchestrate-human-tasks-02

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/dev-environment/dev-getting-started-orchestrate-human-tasks-02.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `dev-getting-started-orchestrate-human-tasks-02` (use exactly this id)
...
- **Heading focus** (optional steer): "Step 1: Create a new process"
...
**Section heading**: Step 1: Create a new process
...
1. Write the JSON to **pipeline/generation/outputs/dev-environment/dev-getting-started-orchestrate-human-tasks-02.json** and nothing else.
2. The id MUST be `dev-getting-started-orchestrate-human-tasks-02`.
...
Overwrite `pipeline/generation/outputs/dev-environment/dev-getting-started-orchestrate-human-tasks-02.json` with a corrected JSON document and stop.
