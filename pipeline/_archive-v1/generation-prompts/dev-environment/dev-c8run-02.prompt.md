...
- **Heading focus** (optional steer): "Configuration options"
...
1. Write the JSON to **pipeline/generation/outputs/dev-environment/dev-c8run-02.json** and nothing else.
2. The id MUST be `dev-c8run-02`.
...
Overwrite `pipeline/generation/outputs/dev-environment/dev-c8run-02.json` with a corrected JSON document and stop.
