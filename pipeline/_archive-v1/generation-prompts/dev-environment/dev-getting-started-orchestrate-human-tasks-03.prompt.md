# Authoring task: dev-getting-started-orchestrate-human-tasks-03

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/dev-environment/dev-getting-started-orchestrate-human-tasks-03.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `dev-getting-started-orchestrate-human-tasks-03` (use exactly this id)
...
1. Write the JSON to **pipeline/generation/outputs/dev-environment/dev-getting-started-orchestrate-human-tasks-03.json** and nothing else.
2. The id MUST be `dev-getting-started-orchestrate-human-tasks-03`.
...
Overwrite `pipeline/generation/outputs/dev-environment/dev-getting-started-orchestrate-human-tasks-03.json` with a corrected JSON document and stop.
