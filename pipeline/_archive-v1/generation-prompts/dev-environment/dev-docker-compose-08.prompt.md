...
1. Write the JSON to **pipeline/generation/outputs/dev-environment/dev-docker-compose-08.json** and nothing else.
2. The id MUST be `dev-docker-compose-08`.
