# Authoring task: frm-camunda-forms-reference-02

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/forms/frm-camunda-forms-reference-02.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `frm-camunda-forms-reference-02` (use exactly this id)
- **topic**: `forms`
- **difficulty**: `easy`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/`
...
**File**: `pipeline/sources/forms/camunda-forms-reference.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/
...
1. Write the JSON to **pipeline/generation/outputs/forms/frm-camunda-forms-reference-02.json** and nothing else.
2. The id MUST be `frm-camunda-forms-reference-02`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/forms/camunda-forms-reference/`.
