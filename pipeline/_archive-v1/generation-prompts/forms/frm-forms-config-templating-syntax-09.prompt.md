# Authoring task: frm-forms-config-templating-syntax-09

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/forms/frm-forms-config-templating-syntax-09.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `frm-forms-config-templating-syntax-09` (use exactly this id)
- **topic**: `forms`
- **difficulty**: `medium`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/forms/configuration/forms-config-templating-syntax/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Feelers syntax"
...
**File**: `pipeline/sources/forms/forms-config-templating-syntax.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/forms/configuration/forms-config-templating-syntax/
**Section heading**: Feelers syntax
...
1. Write the JSON to **pipeline/generation/outputs/forms/frm-forms-config-templating-syntax-09.json** and nothing else.
2. The id MUST be `frm-forms-config-templating-syntax-09`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/forms/configuration/forms-config-templating-syntax/`.
...
Overwrite `pipeline/generation/outputs/forms/frm-forms-config-templating-syntax-09.json` with a corrected JSON document and stop.
