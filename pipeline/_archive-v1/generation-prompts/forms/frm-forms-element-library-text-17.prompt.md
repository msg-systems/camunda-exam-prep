# Authoring task: frm-forms-element-library-text-17

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/forms/frm-forms-element-library-text-17.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `frm-forms-element-library-text-17` (use exactly this id)
- **topic**: `forms`
- **difficulty**: `medium`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/forms/form-element-library/forms-element-library-text/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "This is a sub-heading"
...
**File**: `pipeline/sources/forms/forms-element-library-text.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/forms/form-element-library/forms-element-library-text/
**Section heading**: This is a sub-heading
...
1. Write the JSON to **pipeline/generation/outputs/forms/frm-forms-element-library-text-17.json** and nothing else.
2. The id MUST be `frm-forms-element-library-text-17`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/forms/form-element-library/forms-element-library-text/`.
...
Overwrite `pipeline/generation/outputs/forms/frm-forms-element-library-text-17.json` with a corrected JSON document and stop.
