# Authoring task: frm-forms-config-data-binding-07

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/forms/frm-forms-config-data-binding-07.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `frm-forms-config-data-binding-07` (use exactly this id)
- **topic**: `forms`
- **difficulty**: `medium`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/forms/configuration/forms-config-data-binding/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Binding form fields to process data"
...
**File**: `pipeline/sources/forms/forms-config-data-binding.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/forms/configuration/forms-config-data-binding/
**Section heading**: Binding form fields to process data
...
1. Write the JSON to **pipeline/generation/outputs/forms/frm-forms-config-data-binding-07.json** and nothing else.
2. The id MUST be `frm-forms-config-data-binding-07`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/forms/configuration/forms-config-data-binding/`.
...
Overwrite `pipeline/generation/outputs/forms/frm-forms-config-data-binding-07.json` with a corrected JSON document and stop.
