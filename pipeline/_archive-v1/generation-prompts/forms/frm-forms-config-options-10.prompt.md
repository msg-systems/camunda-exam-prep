...
1. Write the JSON to **pipeline/generation/outputs/forms/frm-forms-config-options-10.json** and nothing else.
2. The id MUST be `frm-forms-config-options-10`.
