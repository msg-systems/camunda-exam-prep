# Authoring task: frm-forms-config-templating-syntax-16

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/forms/frm-forms-config-templating-syntax-16.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `frm-forms-config-templating-syntax-16` (use exactly this id)
- **topic**: `forms`
- **difficulty**: `medium`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
...
1. Write the JSON to **pipeline/generation/outputs/forms/frm-forms-config-templating-syntax-16.json** and nothing else.
2. The id MUST be `frm-forms-config-templating-syntax-16`.
