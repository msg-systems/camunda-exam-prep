# Authoring task: frm-forms-element-library-checkbox-32

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/forms/frm-forms-element-library-checkbox-32.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `frm-forms-element-library-checkbox-32` (use exactly this id)
- **topic**: `forms`
- **difficulty**: `easy`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/forms/form-element-library/forms-element-library-checkbox/`
...
**File**: `pipeline/sources/forms/forms-element-library-checkbox.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/forms/form-element-library/forms-element-library-checkbox/
...
1. Write the JSON to **pipeline/generation/outputs/forms/frm-forms-element-library-checkbox-32.json** and nothing else.
2. The id MUST be `frm-forms-element-library-checkbox-32`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/forms/form-element-library/forms-element-library-checkbox/`.
...
Overwrite `pipeline/generation/outputs/forms/frm-forms-element-library-checkbox-32.json` with a corrected JSON document and stop.
