# Authoring task: frm-forms-config-templating-syntax-17

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/forms/frm-forms-config-templating-syntax-17.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `frm-forms-config-templating-syntax-17` (use exactly this id)
- **topic**: `forms`
- **difficulty**: `medium`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
...
- **Heading focus** (optional steer): "Additional details"
...
1. Write the JSON to **pipeline/generation/outputs/forms/frm-forms-config-templating-syntax-17.json** and nothing else.
2. The id MUST be `frm-forms-config-templating-syntax-17`.
