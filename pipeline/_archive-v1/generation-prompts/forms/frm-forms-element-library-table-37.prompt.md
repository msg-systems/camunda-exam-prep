# Authoring task: frm-forms-element-library-table-37

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/forms/frm-forms-element-library-table-37.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `frm-forms-element-library-table-37` (use exactly this id)
- **topic**: `forms`
- **difficulty**: `hard`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/forms/form-element-library/forms-element-library-table/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Configurable properties"
...
**File**: `pipeline/sources/forms/forms-element-library-table.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/forms/form-element-library/forms-element-library-table/
**Section heading**: Configurable properties
...
1. Write the JSON to **pipeline/generation/outputs/forms/frm-forms-element-library-table-37.json** and nothing else.
2. The id MUST be `frm-forms-element-library-table-37`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/forms/form-element-library/forms-element-library-table/`.
