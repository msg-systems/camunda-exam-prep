# Authoring task: cfg-feel-built-in-functions-string-90

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/configuring-processes/cfg-feel-built-in-functions-string-90.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `cfg-feel-built-in-functions-string-90` (use exactly this id)
- **topic**: `configuring-processes`
- **difficulty**: `hard`
- **style**: `recall`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/feel/builtin-functions/feel-built-in-functions-string/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "substring(string, start position, length)"
...
**File**: `pipeline/sources/configuring-processes/feel-built-in-functions-string.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/feel/builtin-functions/feel-built-in-functions-string/
**Section heading**: substring(string, start position, length)
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-feel-built-in-functions-string-90.json** and nothing else.
2. The id MUST be `cfg-feel-built-in-functions-string-90`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/feel/builtin-functions/feel-built-in-functions-string/`.
...
- [explanation-verdict-mismatch] optionExplanations.a (distractor) must start with "Incorrect." @ optionExplanations.a

Overwrite `pipeline/generation/outputs/configuring-processes/cfg-feel-built-in-functions-string-90.json` with a corrected JSON document and stop.
