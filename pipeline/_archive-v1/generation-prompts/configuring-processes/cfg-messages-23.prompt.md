...
- **Heading focus** (optional steer): "Message response"
...
**Section heading**: Message response
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-messages-23.json** and nothing else.
2. The id MUST be `cfg-messages-23`.
