...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-messages-36.json** and nothing else.
2. The id MUST be `cfg-messages-36`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-messages-36.json` with a corrected JSON document and stop.
