...
**File**: `pipeline/sources/configuring-processes/signals.md`
**Public URL**: https://docs.camunda.io/docs/components/concepts/signals/
**Section heading**: Broadcasting signals
...
- Using the [Orchestration Cluster REST API Broadcast signal](/apis-tools/orchestration-cluster-api-rest/specifications/broadcast-signal.api.mdx) endpoint
- Using Zeebe's [`BroadcastSignal` RPC](/apis-tools/zeebe-api/gateway-service.md#broadcastsignal-rpc)
```

### Final reminders

1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-signals-40.json** and nothing else.
2. The id MUST be `cfg-signals-40`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/concepts/signals/`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-signals-40.json` with a corrected JSON document and stop.
