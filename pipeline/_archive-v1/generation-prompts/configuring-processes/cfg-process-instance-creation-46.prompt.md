# Authoring task: cfg-process-instance-creation-46

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/configuring-processes/cfg-process-instance-creation-46.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `cfg-process-instance-creation-46` (use exactly this id)
...
- **Heading focus** (optional steer): "Create and execute asynchronously"
...
**Section heading**: Create and execute asynchronously
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-process-instance-creation-46.json** and nothing else.
2. The id MUST be `cfg-process-instance-creation-46`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-process-instance-creation-46.json` with a corrected JSON document and stop.
