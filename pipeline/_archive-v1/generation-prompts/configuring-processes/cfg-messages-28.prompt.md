...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-messages-28.json** and nothing else.
2. The id MUST be `cfg-messages-28`.
