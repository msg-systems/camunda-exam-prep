# Authoring task: cfg-what-is-feel-108

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/configuring-processes/cfg-what-is-feel-108.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `cfg-what-is-feel-108` (use exactly this id)
- **topic**: `configuring-processes`
- **difficulty**: `hard`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/feel/what-is-feel/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Learning FEEL"
...
**File**: `pipeline/sources/configuring-processes/what-is-feel.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/feel/what-is-feel/
**Section heading**: Learning FEEL
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-what-is-feel-108.json** and nothing else.
2. The id MUST be `cfg-what-is-feel-108`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/feel/what-is-feel/`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-what-is-feel-108.json` with a corrected JSON document and stop.
