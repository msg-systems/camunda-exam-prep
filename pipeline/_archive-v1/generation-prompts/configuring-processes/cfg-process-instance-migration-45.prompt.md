# Authoring task: cfg-process-instance-migration-45

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/configuring-processes/cfg-process-instance-migration-45.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `cfg-process-instance-migration-45` (use exactly this id)
...
- **Heading focus** (optional steer): "Changing the process instance flow for inactive parts"
...
**Section heading**: Changing the process instance flow for inactive parts
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-process-instance-migration-45.json** and nothing else.
2. The id MUST be `cfg-process-instance-migration-45`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-process-instance-migration-45.json` with a corrected JSON document and stop.
