# Authoring task: cfg-feel-context-expressions-117

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/configuring-processes/cfg-feel-context-expressions-117.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `cfg-feel-context-expressions-117` (use exactly this id)
- **topic**: `configuring-processes`
- **difficulty**: `medium`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/feel/language-guide/feel-context-expressions/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Examples"
...
**File**: `pipeline/sources/configuring-processes/feel-context-expressions.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/feel/language-guide/feel-context-expressions/
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-feel-context-expressions-117.json** and nothing else.
2. The id MUST be `cfg-feel-context-expressions-117`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/feel/language-guide/feel-context-expressions/`.
...
- [explanation-verdict-mismatch] optionExplanations.c (correct option) must start with "Correct." @ optionExplanations.c

Overwrite `pipeline/generation/outputs/configuring-processes/cfg-feel-context-expressions-117.json` with a corrected JSON document and stop.
