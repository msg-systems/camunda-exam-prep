...
- **Heading focus** (optional steer): "Signal cardinality"
...
**Section heading**: Signal cardinality
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-signals-42.json** and nothing else.
2. The id MUST be `cfg-signals-42`.
