...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-variables-17.json** and nothing else.
2. The id MUST be `cfg-variables-17`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-variables-17.json` with a corrected JSON document and stop.
