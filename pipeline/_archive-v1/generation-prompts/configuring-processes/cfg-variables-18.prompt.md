...
- **Heading focus** (optional steer): "Input mappings"
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-variables-18.json** and nothing else.
2. The id MUST be `cfg-variables-18`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-variables-18.json` with a corrected JSON document and stop.
