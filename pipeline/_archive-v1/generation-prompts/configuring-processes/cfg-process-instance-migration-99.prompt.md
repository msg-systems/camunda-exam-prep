# Authoring task: cfg-process-instance-migration-99

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/configuring-processes/cfg-process-instance-migration-99.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `cfg-process-instance-migration-99` (use exactly this id)
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-process-instance-migration-99.json** and nothing else.
2. The id MUST be `cfg-process-instance-migration-99`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-process-instance-migration-99.json` with a corrected JSON document and stop.
