...
- **Heading focus** (optional steer): "Context variable"
...
**Section heading**: Context variable
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-variables-21.json** and nothing else.
2. The id MUST be `cfg-variables-21`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-variables-21.json` with a corrected JSON document and stop.
