...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-incidents-45.json** and nothing else.
2. The id MUST be `cfg-incidents-45`.
