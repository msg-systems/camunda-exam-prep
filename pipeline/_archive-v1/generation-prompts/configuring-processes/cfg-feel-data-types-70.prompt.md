...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-feel-data-types-70.json** and nothing else.
2. The id MUST be `cfg-feel-data-types-70`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-feel-data-types-70.json` with a corrected JSON document and stop.
