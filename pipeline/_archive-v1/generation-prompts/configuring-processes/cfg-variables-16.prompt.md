...
- **Heading focus** (optional steer): "Input/output variable mappings"
...
**Section heading**: Input/output variable mappings
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-variables-16.json** and nothing else.
2. The id MUST be `cfg-variables-16`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-variables-16.json` with a corrected JSON document and stop.
