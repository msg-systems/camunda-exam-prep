...
**File**: `pipeline/sources/configuring-processes/incidents.md`
**Public URL**: https://docs.camunda.io/docs/components/concepts/incidents/
**Section heading**: Resolving
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-incidents-44.json** and nothing else.
2. The id MUST be `cfg-incidents-44`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/concepts/incidents/`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-incidents-44.json` with a corrected JSON document and stop.
