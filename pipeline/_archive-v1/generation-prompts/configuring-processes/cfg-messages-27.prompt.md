...
- **Heading focus** (optional steer): "Message subscriptions"
...
**Section heading**: Message subscriptions
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-messages-27.json** and nothing else.
2. The id MUST be `cfg-messages-27`.
