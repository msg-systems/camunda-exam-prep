...
- **Heading focus** (optional steer): "Output mappings"
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-variables-20.json** and nothing else.
2. The id MUST be `cfg-variables-20`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-variables-20.json` with a corrected JSON document and stop.
