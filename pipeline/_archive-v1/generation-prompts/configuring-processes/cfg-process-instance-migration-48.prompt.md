# Authoring task: cfg-process-instance-migration-48

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/configuring-processes/cfg-process-instance-migration-48.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `cfg-process-instance-migration-48` (use exactly this id)
...
- **Heading focus** (optional steer): "Migrating active elements inside subprocesses"
...
**Section heading**: Migrating active elements inside subprocesses
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-process-instance-migration-48.json** and nothing else.
2. The id MUST be `cfg-process-instance-migration-48`.
