...
- **Heading focus** (optional steer): "Message cardinality"
...
**Section heading**: Message cardinality
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-messages-17.json** and nothing else.
2. The id MUST be `cfg-messages-17`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-messages-17.json` with a corrected JSON document and stop.
