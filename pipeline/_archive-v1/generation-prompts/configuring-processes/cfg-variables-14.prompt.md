...
- **Heading focus** (optional steer): "Variable scopes"
...
**Section heading**: Variable scopes
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-variables-14.json** and nothing else.
2. The id MUST be `cfg-variables-14`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-variables-14.json` with a corrected JSON document and stop.
