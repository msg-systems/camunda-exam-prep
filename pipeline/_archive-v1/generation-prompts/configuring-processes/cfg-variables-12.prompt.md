...
- **Heading focus** (optional steer): "Variable values"
...
**Section heading**: Variable values
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-variables-12.json** and nothing else.
2. The id MUST be `cfg-variables-12`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-variables-12.json` with a corrected JSON document and stop.
