...
- **Heading focus** (optional steer): "Variable names"
...
**Section heading**: Variable names
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-variables-11.json** and nothing else.
2. The id MUST be `cfg-variables-11`.
