...
- **Heading focus** (optional steer): "The expression language"
...
**Section heading**: The expression language
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-expressions-12.json** and nothing else.
2. The id MUST be `cfg-expressions-12`.
