...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-messages-34.json** and nothing else.
2. The id MUST be `cfg-messages-34`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-messages-34.json` with a corrected JSON document and stop.
