# Authoring task: cfg-process-instance-modification-64

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/configuring-processes/cfg-process-instance-modification-64.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `cfg-process-instance-modification-64` (use exactly this id)
...
- **Heading focus** (optional steer): "Set variables"
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-process-instance-modification-64.json** and nothing else.
2. The id MUST be `cfg-process-instance-modification-64`.
