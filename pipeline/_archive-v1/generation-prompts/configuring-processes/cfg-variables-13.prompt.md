# Authoring task: cfg-variables-13

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/configuring-processes/cfg-variables-13.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `cfg-variables-13` (use exactly this id)
- **topic**: `configuring-processes`
- **difficulty**: `medium`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/concepts/variables/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Variable size limitation"
...
**File**: `pipeline/sources/configuring-processes/variables.md`
**Public URL**: https://docs.camunda.io/docs/components/concepts/variables/
**Section heading**: Variable size limitation
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-variables-13.json** and nothing else.
2. The id MUST be `cfg-variables-13`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/concepts/variables/`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-variables-13.json` with a corrected JSON document and stop.
