...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-what-is-feel-107.json** and nothing else.
2. The id MUST be `cfg-what-is-feel-107`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-what-is-feel-107.json` with a corrected JSON document and stop.
