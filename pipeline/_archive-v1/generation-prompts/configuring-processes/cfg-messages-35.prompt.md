...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-messages-35.json** and nothing else.
2. The id MUST be `cfg-messages-35`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-messages-35.json` with a corrected JSON document and stop.
