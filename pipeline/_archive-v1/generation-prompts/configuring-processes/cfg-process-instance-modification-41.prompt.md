# Authoring task: cfg-process-instance-modification-41

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/configuring-processes/cfg-process-instance-modification-41.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `cfg-process-instance-modification-41` (use exactly this id)
- **topic**: `configuring-processes`
- **difficulty**: `hard`
- **style**: `recall`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/concepts/process-instance-modification/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Execute the modification instructions"
...
**File**: `pipeline/sources/configuring-processes/process-instance-modification.md`
**Public URL**: https://docs.camunda.io/docs/components/concepts/process-instance-modification/
**Section heading**: Execute the modification instructions
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-process-instance-modification-41.json** and nothing else.
2. The id MUST be `cfg-process-instance-modification-41`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/concepts/process-instance-modification/`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-process-instance-modification-41.json` with a corrected JSON document and stop.
