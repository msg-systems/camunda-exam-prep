...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-messages-32.json** and nothing else.
2. The id MUST be `cfg-messages-32`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-messages-32.json` with a corrected JSON document and stop.
