...
- **Heading focus** (optional steer): "Message buffering"
...
**Section heading**: Message buffering
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-messages-16.json** and nothing else.
2. The id MUST be `cfg-messages-16`.
