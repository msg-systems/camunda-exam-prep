# Authoring task: cfg-feel-built-in-functions-conversion-135

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/configuring-processes/cfg-feel-built-in-functions-conversion-135.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `cfg-feel-built-in-functions-conversion-135` (use exactly this id)
- **topic**: `configuring-processes`
- **difficulty**: `medium`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/feel/builtin-functions/feel-built-in-functions-conversion/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "number(from, grouping separator, decimal separator)"
...
**File**: `pipeline/sources/configuring-processes/feel-built-in-functions-conversion.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/feel/builtin-functions/feel-built-in-functions-conversion/
**Section heading**: number(from, grouping separator, decimal separator)
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-feel-built-in-functions-conversion-135.json** and nothing else.
2. The id MUST be `cfg-feel-built-in-functions-conversion-135`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/feel/builtin-functions/feel-built-in-functions-conversion/`.
