...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-variables-19.json** and nothing else.
2. The id MUST be `cfg-variables-19`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-variables-19.json` with a corrected JSON document and stop.
