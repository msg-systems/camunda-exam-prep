# Authoring task: cfg-feel-built-in-functions-numeric-157

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/configuring-processes/cfg-feel-built-in-functions-numeric-157.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `cfg-feel-built-in-functions-numeric-157` (use exactly this id)
- **topic**: `configuring-processes`
- **difficulty**: `medium`
- **style**: `recall`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/feel/builtin-functions/feel-built-in-functions-numeric/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "round half down(n, scale)"
...
**File**: `pipeline/sources/configuring-processes/feel-built-in-functions-numeric.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/feel/builtin-functions/feel-built-in-functions-numeric/
**Section heading**: round half down(n, scale)
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-feel-built-in-functions-numeric-157.json** and nothing else.
2. The id MUST be `cfg-feel-built-in-functions-numeric-157`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/feel/builtin-functions/feel-built-in-functions-numeric/`.
