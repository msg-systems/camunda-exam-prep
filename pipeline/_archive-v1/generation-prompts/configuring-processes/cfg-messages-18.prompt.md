...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-messages-18.json** and nothing else.
2. The id MUST be `cfg-messages-18`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-messages-18.json` with a corrected JSON document and stop.
