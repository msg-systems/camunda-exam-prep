...
- **Heading focus** (optional steer): "Signal subscriptions"
...
**Section heading**: Signal subscriptions
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-signals-41.json** and nothing else.
2. The id MUST be `cfg-signals-41`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-signals-41.json` with a corrected JSON document and stop.
