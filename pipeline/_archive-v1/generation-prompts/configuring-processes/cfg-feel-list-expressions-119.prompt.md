# Authoring task: cfg-feel-list-expressions-119

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/configuring-processes/cfg-feel-list-expressions-119.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `cfg-feel-list-expressions-119` (use exactly this id)
- **topic**: `configuring-processes`
- **difficulty**: `medium`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/modeler/feel/language-guide/feel-list-expressions/`
...
**File**: `pipeline/sources/configuring-processes/feel-list-expressions.md`
**Public URL**: https://docs.camunda.io/docs/components/modeler/feel/language-guide/feel-list-expressions/
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-feel-list-expressions-119.json** and nothing else.
2. The id MUST be `cfg-feel-list-expressions-119`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/modeler/feel/language-guide/feel-list-expressions/`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-feel-list-expressions-119.json` with a corrected JSON document and stop.
