# Authoring task: cfg-process-instance-modification-43

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/configuring-processes/cfg-process-instance-modification-43.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `cfg-process-instance-modification-43` (use exactly this id)
...
- **Heading focus** (optional steer): "Use at your own risk"
...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-process-instance-modification-43.json** and nothing else.
2. The id MUST be `cfg-process-instance-modification-43`.
...
Overwrite `pipeline/generation/outputs/configuring-processes/cfg-process-instance-modification-43.json` with a corrected JSON document and stop.
