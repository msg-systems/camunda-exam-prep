...
1. Write the JSON to **pipeline/generation/outputs/configuring-processes/cfg-variables-01.json** and nothing else.
2. The id MUST be `cfg-variables-01`.
