# Authoring task: ext-properties-reference-92

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-properties-reference-92.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-properties-reference-92` (use exactly this id)
- **topic**: `extensions-integrations`
- **difficulty**: `hard`
- **style**: `recall`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/apis-tools/camunda-spring-boot-starter/properties-reference/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "`zeebe.client.cloud`"
...
**File**: `pipeline/sources/extensions-integrations/properties-reference.md`
**Public URL**: https://docs.camunda.io/docs/apis-tools/camunda-spring-boot-starter/properties-reference/
**Section heading**: `zeebe.client.cloud`
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-properties-reference-92.json** and nothing else.
2. The id MUST be `ext-properties-reference-92`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/apis-tools/camunda-spring-boot-starter/properties-reference/`.
...
Overwrite `pipeline/generation/outputs/extensions-integrations/ext-properties-reference-92.json` with a corrected JSON document and stop.
