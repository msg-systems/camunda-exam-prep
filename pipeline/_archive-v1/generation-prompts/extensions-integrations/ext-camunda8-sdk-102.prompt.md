...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-camunda8-sdk-102.json** and nothing else.
2. The id MUST be `ext-camunda8-sdk-102`.
