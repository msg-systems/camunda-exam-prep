...
- **Heading focus** (optional steer): "Create a programmatic user task worker"
...
**Section heading**: Create a programmatic user task worker
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-camunda8-sdk-104.json** and nothing else.
2. The id MUST be `ext-camunda8-sdk-104`.
