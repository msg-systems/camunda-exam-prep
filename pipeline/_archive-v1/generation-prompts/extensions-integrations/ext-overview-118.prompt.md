...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-overview-118.json** and nothing else.
2. The id MUST be `ext-overview-118`.
