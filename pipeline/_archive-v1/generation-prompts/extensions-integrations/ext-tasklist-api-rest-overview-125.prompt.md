# Authoring task: ext-tasklist-api-rest-overview-125

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-tasklist-api-rest-overview-125.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-tasklist-api-rest-overview-125` (use exactly this id)
- **topic**: `extensions-integrations`
- **difficulty**: `medium`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/apis-tools/tasklist-api-rest/tasklist-api-rest-overview/`
...
**File**: `pipeline/sources/extensions-integrations/tasklist-api-rest-overview.md`
**Public URL**: https://docs.camunda.io/docs/apis-tools/tasklist-api-rest/tasklist-api-rest-overview/
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-tasklist-api-rest-overview-125.json** and nothing else.
2. The id MUST be `ext-tasklist-api-rest-overview-125`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/apis-tools/tasklist-api-rest/tasklist-api-rest-overview/`.
