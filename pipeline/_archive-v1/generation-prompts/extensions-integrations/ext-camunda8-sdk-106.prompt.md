...
- **Heading focus** (optional steer): "Retrieve a process instance"
...
**Section heading**: Retrieve a process instance
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-camunda8-sdk-106.json** and nothing else.
2. The id MUST be `ext-camunda8-sdk-106`.
