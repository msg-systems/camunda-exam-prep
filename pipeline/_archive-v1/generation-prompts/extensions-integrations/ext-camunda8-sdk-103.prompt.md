...
- **Heading focus** (optional steer): "Create a service worker"
...
**Section heading**: Create a service worker
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-camunda8-sdk-103.json** and nothing else.
2. The id MUST be `ext-camunda8-sdk-103`.
...
Overwrite `pipeline/generation/outputs/extensions-integrations/ext-camunda8-sdk-103.json` with a corrected JSON document and stop.
