# Authoring task: ext-getting-started-42

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-getting-started-42.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-getting-started-42` (use exactly this id)
- **topic**: `extensions-integrations`
- **difficulty**: `medium`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/apis-tools/camunda-spring-boot-starter/getting-started/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Deploy process models"
...
**File**: `pipeline/sources/extensions-integrations/getting-started.md`
**Public URL**: https://docs.camunda.io/docs/apis-tools/camunda-spring-boot-starter/getting-started/
**Section heading**: Deploy process models
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-getting-started-42.json** and nothing else.
2. The id MUST be `ext-getting-started-42`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/apis-tools/camunda-spring-boot-starter/getting-started/`.
