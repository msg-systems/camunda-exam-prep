# Authoring task: ext-local-development-with-element-templates-191

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-local-development-with-element-templates-191.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-local-development-with-element-templates-191` (use exactly this id)
...
- **Heading focus** (optional steer): "Provisioning a custom connector runtime"
...
**Section heading**: Provisioning a custom connector runtime
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-local-development-with-element-templates-191.json** and nothing else.
2. The id MUST be `ext-local-development-with-element-templates-191`.
