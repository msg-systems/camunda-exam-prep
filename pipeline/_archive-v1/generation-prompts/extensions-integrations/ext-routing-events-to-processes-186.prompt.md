# Authoring task: ext-routing-events-to-processes-186

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-routing-events-to-processes-186.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-routing-events-to-processes-186` (use exactly this id)
...
- **Heading focus** (optional steer): "Technology examples for messages sent by external systems"
...
**Section heading**: Technology examples for messages sent by external systems
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-routing-events-to-processes-186.json** and nothing else.
2. The id MUST be `ext-routing-events-to-processes-186`.
...
- [option-self-rationale] option contains self-rationale clause @ options[2]
- [meta-vocab-in-option] meta-vocabulary leak @ options[3]
- [option-self-rationale] option contains self-rationale clause @ options[3]

Overwrite `pipeline/generation/outputs/extensions-integrations/ext-routing-events-to-processes-186.json` with a corrected JSON document and stop.
