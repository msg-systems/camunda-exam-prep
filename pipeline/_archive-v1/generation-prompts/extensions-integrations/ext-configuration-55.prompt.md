...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-configuration-55.json** and nothing else.
2. The id MUST be `ext-configuration-55`.
