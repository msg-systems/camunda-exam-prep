# Authoring task: ext-properties-reference-94

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-properties-reference-94.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-properties-reference-94` (use exactly this id)
...
- **Heading focus** (optional steer): "`zeebe.client.message`"
...
**Section heading**: `zeebe.client.message`
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-properties-reference-94.json** and nothing else.
2. The id MUST be `ext-properties-reference-94`.
