...
- **Heading focus** (optional steer): "Requesting jobs"
...
**Section heading**: Requesting jobs
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-job-workers-09.json** and nothing else.
2. The id MUST be `ext-job-workers-09`.
