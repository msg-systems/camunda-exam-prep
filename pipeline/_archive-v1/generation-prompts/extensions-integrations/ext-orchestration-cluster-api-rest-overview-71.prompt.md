# Authoring task: ext-orchestration-cluster-api-rest-overview-71

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-orchestration-cluster-api-rest-overview-71.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-orchestration-cluster-api-rest-overview-71` (use exactly this id)
...
- **Heading focus** (optional steer): "HTTP status codes & error handling"
...
**Section heading**: HTTP status codes & error handling
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-orchestration-cluster-api-rest-overview-71.json** and nothing else.
2. The id MUST be `ext-orchestration-cluster-api-rest-overview-71`.
...
Overwrite `pipeline/generation/outputs/extensions-integrations/ext-orchestration-cluster-api-rest-overview-71.json` with a corrected JSON document and stop.
