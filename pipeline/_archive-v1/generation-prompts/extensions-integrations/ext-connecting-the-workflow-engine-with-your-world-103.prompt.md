# Authoring task: ext-connecting-the-workflow-engine-with-your-world-103

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-connecting-the-workflow-engine-with-your-world-103.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-connecting-the-workflow-engine-with-your-world-103` (use exactly this id)
- **topic**: `extensions-integrations`
- **difficulty**: `medium`
- **style**: `recall`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/best-practices/development/connecting-the-workflow-engine-with-your-world/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Designing process solutions containing all glue code"
...
**File**: `pipeline/sources/extensions-integrations/connecting-the-workflow-engine-with-your-world.md`
**Public URL**: https://docs.camunda.io/docs/components/best-practices/development/connecting-the-workflow-engine-with-your-world/
**Section heading**: Designing process solutions containing all glue code
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-connecting-the-workflow-engine-with-your-world-103.json** and nothing else.
2. The id MUST be `ext-connecting-the-workflow-engine-with-your-world-103`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/best-practices/development/connecting-the-workflow-engine-with-your-world/`.
...
Overwrite `pipeline/generation/outputs/extensions-integrations/ext-connecting-the-workflow-engine-with-your-world-103.json` with a corrected JSON document and stop.
