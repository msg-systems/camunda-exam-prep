# Authoring task: ext-local-development-with-element-templates-120

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-local-development-with-element-templates-120.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-local-development-with-element-templates-120` (use exactly this id)
- **topic**: `extensions-integrations`
- **difficulty**: `medium`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/components/best-practices/development/local-development-with-element-templates/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Provisioning other dependencies"
...
**File**: `pipeline/sources/extensions-integrations/local-development-with-element-templates.md`
**Public URL**: https://docs.camunda.io/docs/components/best-practices/development/local-development-with-element-templates/
**Section heading**: Provisioning other dependencies
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-local-development-with-element-templates-120.json** and nothing else.
2. The id MUST be `ext-local-development-with-element-templates-120`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/components/best-practices/development/local-development-with-element-templates/`.
...
Overwrite `pipeline/generation/outputs/extensions-integrations/ext-local-development-with-element-templates-120.json` with a corrected JSON document and stop.
