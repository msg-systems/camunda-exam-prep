...
- **Heading focus** (optional steer): "Workarounds for additional metrics"
...
**Section heading**: Workarounds for additional metrics
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-job-worker-19.json** and nothing else.
2. The id MUST be `ext-job-worker-19`.
