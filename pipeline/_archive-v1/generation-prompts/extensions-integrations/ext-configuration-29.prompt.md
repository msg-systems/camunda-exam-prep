...
- **Heading focus** (optional steer): "Control variable fetching"
...
**Section heading**: Control variable fetching
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-configuration-29.json** and nothing else.
2. The id MUST be `ext-configuration-29`.
