...
- **Heading focus** (optional steer): "Job type"
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-configuration-48.json** and nothing else.
2. The id MUST be `ext-configuration-48`.
