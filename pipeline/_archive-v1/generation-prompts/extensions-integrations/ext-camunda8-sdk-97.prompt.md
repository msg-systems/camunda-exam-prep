...
- **Heading focus** (optional steer): "About this SDK"
...
**Section heading**: About this SDK
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-camunda8-sdk-97.json** and nothing else.
2. The id MUST be `ext-camunda8-sdk-97`.
