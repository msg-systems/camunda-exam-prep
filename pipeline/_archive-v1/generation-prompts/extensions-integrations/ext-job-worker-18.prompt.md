...
- **Heading focus** (optional steer): "Usage"
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-job-worker-18.json** and nothing else.
2. The id MUST be `ext-job-worker-18`.
...
Overwrite `pipeline/generation/outputs/extensions-integrations/ext-job-worker-18.json` with a corrected JSON document and stop.
