...
- **Heading focus** (optional steer): "Change objects"
...
**Section heading**: Change objects
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-overview-123.json** and nothing else.
2. The id MUST be `ext-overview-123`.
