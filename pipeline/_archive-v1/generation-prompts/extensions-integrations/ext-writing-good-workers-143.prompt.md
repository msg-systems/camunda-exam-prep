# Authoring task: ext-writing-good-workers-143

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-writing-good-workers-143.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-writing-good-workers-143` (use exactly this id)
...
- **Heading focus** (optional steer): "Organizing glue code and workers in process solutions"
...
**Section heading**: Organizing glue code and workers in process solutions
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-writing-good-workers-143.json** and nothing else.
2. The id MUST be `ext-writing-good-workers-143`.
