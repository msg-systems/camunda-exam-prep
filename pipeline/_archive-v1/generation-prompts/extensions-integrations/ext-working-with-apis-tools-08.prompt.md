# Authoring task: ext-working-with-apis-tools-08

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-working-with-apis-tools-08.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-working-with-apis-tools-08` (use exactly this id)
- **topic**: `extensions-integrations`
- **difficulty**: `hard`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/apis-tools/working-with-apis-tools/`
...
**File**: `pipeline/sources/extensions-integrations/working-with-apis-tools.md`
**Public URL**: https://docs.camunda.io/docs/apis-tools/working-with-apis-tools/
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-working-with-apis-tools-08.json** and nothing else.
2. The id MUST be `ext-working-with-apis-tools-08`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/apis-tools/working-with-apis-tools/`.
...
Overwrite `pipeline/generation/outputs/extensions-integrations/ext-working-with-apis-tools-08.json` with a corrected JSON document and stop.
