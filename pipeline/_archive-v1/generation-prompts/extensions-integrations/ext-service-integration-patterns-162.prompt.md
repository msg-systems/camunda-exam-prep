# Authoring task: ext-service-integration-patterns-162

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-service-integration-patterns-162.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-service-integration-patterns-162` (use exactly this id)
...
- **Heading focus** (optional steer): "Hiding technical complexity behind call activities"
...
**Section heading**: Hiding technical complexity behind call activities
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-service-integration-patterns-162.json** and nothing else.
2. The id MUST be `ext-service-integration-patterns-162`.
