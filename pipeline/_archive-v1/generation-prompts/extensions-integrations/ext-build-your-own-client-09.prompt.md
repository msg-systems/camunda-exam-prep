# Authoring task: ext-build-your-own-client-09

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-build-your-own-client-09.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-build-your-own-client-09` (use exactly this id)
- **topic**: `extensions-integrations`
- **difficulty**: `medium`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/apis-tools/build-your-own-client/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Authentication via OAuth"
...
**File**: `pipeline/sources/extensions-integrations/build-your-own-client.md`
**Public URL**: https://docs.camunda.io/docs/apis-tools/build-your-own-client/
**Section heading**: Authentication via OAuth
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-build-your-own-client-09.json** and nothing else.
2. The id MUST be `ext-build-your-own-client-09`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/apis-tools/build-your-own-client/`.
...
Overwrite `pipeline/generation/outputs/extensions-integrations/ext-build-your-own-client-09.json` with a corrected JSON document and stop.
