# Authoring task: ext-writing-good-workers-146

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-writing-good-workers-146.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-writing-good-workers-146` (use exactly this id)
...
- **Heading focus** (optional steer): "Performance best-practices"
...
**Section heading**: Performance best-practices
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-writing-good-workers-146.json** and nothing else.
2. The id MUST be `ext-writing-good-workers-146`.
