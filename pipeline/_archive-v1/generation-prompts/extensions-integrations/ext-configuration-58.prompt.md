...
- **Heading focus** (optional steer): "Observing metrics"
...
**Section heading**: Observing metrics
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-configuration-58.json** and nothing else.
2. The id MUST be `ext-configuration-58`.
