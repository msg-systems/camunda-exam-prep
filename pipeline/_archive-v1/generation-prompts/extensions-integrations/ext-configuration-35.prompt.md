# Authoring task: ext-configuration-35

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-configuration-35.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-configuration-35` (use exactly this id)
- **topic**: `extensions-integrations`
- **difficulty**: `easy`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/apis-tools/camunda-spring-boot-starter/configuration/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Reacting on events"
...
**File**: `pipeline/sources/extensions-integrations/configuration.md`
**Public URL**: https://docs.camunda.io/docs/apis-tools/camunda-spring-boot-starter/configuration/
**Section heading**: Reacting on events
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-configuration-35.json** and nothing else.
2. The id MUST be `ext-configuration-35`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/apis-tools/camunda-spring-boot-starter/configuration/`.
...
Overwrite `pipeline/generation/outputs/extensions-integrations/ext-configuration-35.json` with a corrected JSON document and stop.
