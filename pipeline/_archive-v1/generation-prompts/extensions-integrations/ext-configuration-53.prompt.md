...
- **Heading focus** (optional steer): "Completing jobs"
...
**Section heading**: Completing jobs
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-configuration-53.json** and nothing else.
2. The id MUST be `ext-configuration-53`.
