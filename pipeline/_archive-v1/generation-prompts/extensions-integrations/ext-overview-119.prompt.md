...
- **Heading focus** (optional steer): "Query"
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-overview-119.json** and nothing else.
2. The id MUST be `ext-overview-119`.
