...
- **Heading focus** (optional steer): "Available metrics"
...
**Section heading**: Available metrics
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-job-worker-17.json** and nothing else.
2. The id MUST be `ext-job-worker-17`.
