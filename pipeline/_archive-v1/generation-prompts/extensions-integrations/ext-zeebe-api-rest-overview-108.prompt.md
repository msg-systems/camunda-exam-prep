# Authoring task: ext-zeebe-api-rest-overview-108

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-zeebe-api-rest-overview-108.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-zeebe-api-rest-overview-108` (use exactly this id)
- **topic**: `extensions-integrations`
- **difficulty**: `hard`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/apis-tools/zeebe-api-rest/zeebe-api-rest-overview/`
- **docs[0].title**: short page title (look at the source's H1 below)
- **Heading focus** (optional steer): "Context paths"
...
**File**: `pipeline/sources/extensions-integrations/zeebe-api-rest-overview.md`
**Public URL**: https://docs.camunda.io/docs/apis-tools/zeebe-api-rest/zeebe-api-rest-overview/
**Section heading**: Context paths
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-zeebe-api-rest-overview-108.json** and nothing else.
2. The id MUST be `ext-zeebe-api-rest-overview-108`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/apis-tools/zeebe-api-rest/zeebe-api-rest-overview/`.
