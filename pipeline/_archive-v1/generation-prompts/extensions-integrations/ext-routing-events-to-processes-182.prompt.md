# Authoring task: ext-routing-events-to-processes-182

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-routing-events-to-processes-182.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-routing-events-to-processes-182` (use exactly this id)
...
- **Heading focus** (optional steer): "Start events"
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-routing-events-to-processes-182.json** and nothing else.
2. The id MUST be `ext-routing-events-to-processes-182`.
...
- [meta-vocab-in-option] meta-vocabulary leak @ options[0]
- [meta-vocab-in-option] meta-vocabulary leak @ options[1]
- [meta-vocab-in-option] meta-vocabulary leak @ options[2]
- [meta-vocab-in-option] meta-vocabulary leak @ options[3]

Overwrite `pipeline/generation/outputs/extensions-integrations/ext-routing-events-to-processes-182.json` with a corrected JSON document and stop.
