...
- **Heading focus** (optional steer): "Reacting on problems"
...
**Section heading**: Reacting on problems
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-configuration-54.json** and nothing else.
2. The id MUST be `ext-configuration-54`.
