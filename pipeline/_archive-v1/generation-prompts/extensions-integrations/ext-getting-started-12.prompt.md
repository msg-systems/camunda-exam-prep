# Authoring task: ext-getting-started-12

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-getting-started-12.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-getting-started-12` (use exactly this id)
- **topic**: `extensions-integrations`
- **difficulty**: `medium`
- **style**: `concept`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/apis-tools/java-client/getting-started/`
...
**Public URL**: https://docs.camunda.io/docs/apis-tools/java-client/getting-started/
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-getting-started-12.json** and nothing else.
2. The id MUST be `ext-getting-started-12`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/apis-tools/java-client/getting-started/`.
