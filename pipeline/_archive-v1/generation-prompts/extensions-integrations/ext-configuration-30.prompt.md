...
- **Heading focus** (optional steer): "Define job worker function parameters"
...
**Section heading**: Define job worker function parameters
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-configuration-30.json** and nothing else.
2. The id MUST be `ext-configuration-30`.
