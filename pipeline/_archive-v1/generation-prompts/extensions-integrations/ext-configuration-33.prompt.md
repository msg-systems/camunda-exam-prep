...
- **Heading focus** (optional steer): "Further job worker configuration options"
...
**Section heading**: Further job worker configuration options
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-configuration-33.json** and nothing else.
2. The id MUST be `ext-configuration-33`.
