...
- **Heading focus** (optional steer): "Quick start"
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-job-worker-14.json** and nothing else.
2. The id MUST be `ext-job-worker-14`.
