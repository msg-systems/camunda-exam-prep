# Authoring task: ext-dealing-with-problems-and-exceptions-136

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-dealing-with-problems-and-exceptions-136.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-dealing-with-problems-and-exceptions-136` (use exactly this id)
...
- **Heading focus** (optional steer): "Business strategies to handle inconsistency"
...
**Section heading**: Business strategies to handle inconsistency
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-dealing-with-problems-and-exceptions-136.json** and nothing else.
2. The id MUST be `ext-dealing-with-problems-and-exceptions-136`.
