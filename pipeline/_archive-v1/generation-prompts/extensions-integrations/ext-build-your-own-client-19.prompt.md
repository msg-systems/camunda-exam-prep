# Authoring task: ext-build-your-own-client-19

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-build-your-own-client-19.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-build-your-own-client-19` (use exactly this id)
...
- **Heading focus** (optional steer): "gRPC handling"
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-build-your-own-client-19.json** and nothing else.
2. The id MUST be `ext-build-your-own-client-19`.
