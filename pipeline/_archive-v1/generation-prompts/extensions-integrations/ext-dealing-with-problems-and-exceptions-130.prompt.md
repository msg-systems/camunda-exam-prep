# Authoring task: ext-dealing-with-problems-and-exceptions-130

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-dealing-with-problems-and-exceptions-130.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-dealing-with-problems-and-exceptions-130` (use exactly this id)
...
- **Heading focus** (optional steer): "Throwing and handling BPMN errors"
...
**Section heading**: Throwing and handling BPMN errors
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-dealing-with-problems-and-exceptions-130.json** and nothing else.
2. The id MUST be `ext-dealing-with-problems-and-exceptions-130`.
