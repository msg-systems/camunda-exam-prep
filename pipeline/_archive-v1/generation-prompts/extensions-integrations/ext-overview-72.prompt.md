...
**File**: `pipeline/sources/extensions-integrations/overview.md`
**Public URL**: https://docs.camunda.io/docs/apis-tools/operate-api/overview/
**Section heading**: API Explorer
...
The [Orchestration Cluster REST API v.2](../orchestration-cluster-api-rest/orchestration-cluster-api-rest-overview.md) returns `id` and `key` values as strings, so this limitation does not apply.
:::
```

### Final reminders

1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-overview-72.json** and nothing else.
2. The id MUST be `ext-overview-72`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/apis-tools/operate-api/overview/`.
...
Overwrite `pipeline/generation/outputs/extensions-integrations/ext-overview-72.json` with a corrected JSON document and stop.
