...
- **Heading focus** (optional steer): "Multi-tenancy"
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-job-worker-21.json** and nothing else.
2. The id MUST be `ext-job-worker-21`.
