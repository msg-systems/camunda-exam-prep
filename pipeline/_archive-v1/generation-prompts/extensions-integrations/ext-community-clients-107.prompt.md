# Authoring task: ext-community-clients-107

You are writing one Camunda 8.8 Certified Developer exam question. Output **only** the JSON file at:

    pipeline/generation/outputs/extensions-integrations/ext-community-clients-107.json

No other files. No commentary. Valid JSON, no trailing commas, no comments.

## Work item

- **id**: `ext-community-clients-107` (use exactly this id)
- **topic**: `extensions-integrations`
- **difficulty**: `medium`
- **style**: `scenario`
- **camundaVersion**: `"8.8"`
- **docs[0].url**: `https://docs.camunda.io/docs/apis-tools/community-clients/`
...
**File**: `pipeline/sources/extensions-integrations/community-clients.md`
**Public URL**: https://docs.camunda.io/docs/apis-tools/community-clients/
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-community-clients-107.json** and nothing else.
2. The id MUST be `ext-community-clients-107`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/apis-tools/community-clients/`.
