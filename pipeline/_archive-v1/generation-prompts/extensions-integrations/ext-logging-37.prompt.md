...
**File**: `pipeline/sources/extensions-integrations/logging.md`
**Public URL**: https://docs.camunda.io/docs/apis-tools/java-client/logging/
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-logging-37.json** and nothing else.
2. The id MUST be `ext-logging-37`.
3. The docs[0].url MUST be `https://docs.camunda.io/docs/apis-tools/java-client/logging/`.
