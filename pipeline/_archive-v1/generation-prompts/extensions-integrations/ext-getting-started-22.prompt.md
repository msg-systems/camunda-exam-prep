...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-getting-started-22.json** and nothing else.
2. The id MUST be `ext-getting-started-22`.
