...
- **Heading focus** (optional steer): "Get object by key"
...
**Section heading**: Get object by key
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-overview-122.json** and nothing else.
2. The id MUST be `ext-overview-122`.
