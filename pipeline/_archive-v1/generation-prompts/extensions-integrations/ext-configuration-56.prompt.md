...
- **Heading focus** (optional steer): "Deploying resources on start-up"
...
**Section heading**: Deploying resources on start-up
...
1. Write the JSON to **pipeline/generation/outputs/extensions-integrations/ext-configuration-56.json** and nothing else.
2. The id MUST be `ext-configuration-56`.
